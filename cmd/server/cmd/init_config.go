...
func initConfig(cmd *cobra.Command) error {
	...
	_ = viper.BindPFlag("nginx_template_file", cmd.Flags().Lookup("nginx-template-file"))
	_ = viper.BindPFlag("openresty_path", cmd.Flags().Lookup("openresty-path"))
	_ = viper.BindPFlag("balancer_config_api", cmd.Flags().Lookup("balancer-config-api"))
	_ = viper.BindPFlag("redis_addr", cmd.Flags().Lookup("redis-addr"))
